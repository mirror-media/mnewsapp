...
abstract class SearchRepos {
  ...
  Future<StoryListItemList> searchNextPageByKeyword(String keyword, {int loadingMorePage = 20});
}
...
class SearchServices implements SearchRepos{
  ...
  @override
  Future<StoryListItemList> searchNextPageByKeyword(String keyword, {int loadingMorePage = 20}) async{
    from = from + size;
